...
if(! defined('ALLOW_ALL_EXTERNAL_SITES') ) 	define ('ALLOW_ALL_EXTERNAL_SITES', TRUE); // WAS FALSE				// Less secure. 
...
if(! defined('MAX_FILE_SIZE') )				define ('MAX_FILE_SIZE', 990485760);						// 10 Megs is 10485760. This is the max internal or external file size that we'll process.  
