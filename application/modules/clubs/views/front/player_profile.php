                ...
                <div class="snglRowPrfl clearfix">
                    ...
                    <!-- <div class="snglFldPrfl">
                        <div class="input-group">
                            ...
                            <p id="gen"><?php if($club_info->gender && $club_info->gender!='0' && $club_info->gender!='') { echo $genderType[$club_info->gender];}else{ echo "<strong>N/A</strong>"; } ?></p>
                        </div>
                    </div> -->
                </div>
                <!-- <div class="snglRowPrfl clearfix">
                    <div class="snglFldPrfl">
                        <div class="input-group">
                            ...
                            <p id="hgt"><?php if(isset($club_info->height) && $club_info->height!='0' && $club_info->height!='') {echo $club_info->height; } else{ echo "<strong>N/A</strong>"; }?></p>
                        </div>
                    </div>
                    <div class="snglFldPrfl">
                        <div class="input-group">
                            <label><?php echo lang('weight_label'); ?></label>
                            <p id="wgt"><?php if(isset($club_info->weight) && $club_info->weight!='0' && $club_info->weight!=''){ echo $club_info->weight;} else{ echo "<strong>N/A</strong>"; } ?></p>
                        </div>
                    </div>
                    <div class="snglFldPrfl">
                        <div class="input-group">
                            <label><?php echo lang('laterality_label'); ?></label>
                            <p id="lat"><?php if(isset($club_info->laterality) && $club_info->laterality!='0' && $club_info->laterality!=''){ echo $laterality[$club_info->laterality];}else{ echo "<strong>N/A</strong>"; } ?></p>
                        </div>
                    </div>
                </div> -->
                <!-- <div class="snglRowPrfl clearfix">
                    ...
                    <div class="snglFldPrfl">
                        <div class="input-group">
                            ...
                            <p id="cpff"><?php if(isset($club_info->cpf) && $club_info->cpf!='0' && $club_info->cpf!='' && $club_info->cpf!='null') { echo $club_info->cpf;} else{ echo "<strong>xxx.xxx.xxx-xx</strong>"; } ?></p>
                        </div>
                    </div>
                    <div class="snglFldPrfl">
                        <div class="input-group">
                            <label><?php echo lang('playing_position1_label'); ?></label>
                            <p id="position-1"><?php if(isset($club_info->position_1) && $club_info->position_1!='0' && $club_info->position_1!='') {echo $positions[$club_info->position_1];} else{ echo "<strong>N/A</strong>"; } ?></p>
                        </div>
                    </div>
                </div> -->
                ...
                <!-- <div class="snglRowPrfl clearfix">
                    <div class="snglFldPrfl">
                        <div class="input-group">
                            ...
                            <p id="position-2"><?php if(isset($club_info->position_2) && $club_info->position_2!='0' && $club_info->position_2!=''){ echo $positions[$club_info->position_2]; } else{ echo "<strong>N/A</strong>"; }?></p>
                        </div>
                    </div>
                    ...
                    <div class="snglFldPrfl">
                        <div class="input-group">
                            ...
                            <p id="position-3"><?php if(isset($club_info->position_3) && $club_info->position_3!='0' && $club_info->position_3!=''){ echo $positions[$club_info->position_3];} else{ echo "<strong>N/A</strong>"; } ?></p>
                        </div>
                    </div>
                    ...
                    <div class="snglFldPrfl">
                        <div class="input-group">
                            ...
                            <p id="play-type"><?php if(isset($club_info->player_type) && $club_info->player_type!='0' && $club_info->player_type!=''){ echo $playerType[$club_info->player_type]; }else{ echo "<strong>N/A</strong>"; }?></p>
                        </div>
                    </div>

                </div> -->

                <?php //if($club_info->player_type=='1'){ ?>
                 <!-- <div class="snglRowPrfl clearfix show_hide_club">
                    <div class="snglFldPrfl">
                        <div class="input-group">
                            <label><?php echo lang('hire_club_name_label'); ?></label>
                            <p id="club_name"><?php if(isset($club_info->hire_club_name) && $club_info->hire_club_name!='0' && $club_info->hire_club_name!=''){ echo $club_info->hire_club_name; }else{ echo "<strong>N/A</strong>"; }?></p>
                        </div>
                    </div>
                </div> -->
                <?php //} ?>
