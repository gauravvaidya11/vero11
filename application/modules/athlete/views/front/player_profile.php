        ...
        <div class="profile_right">
            ...
            <div class="row">
                <div class="col-sm-12 main-contact-form">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group comman-group">
                                <label for="exampleInputEmail1"><?php echo lang('playing_position2_label'); //pr($player_info);?></label>
                        ...
                        <?php if($player_info->player_type=='1'){ ?>
                            <div class="col-sm-4 show_hide_club">
                                <div class="form-group comman-group">
                                    <label for="exampleInputEmail1"><?php echo lang('club_name_label'); ?></label>
                        ...
                        <div class="col-sm-12 commann-heading commann-heading-2 ">
                            <h3><?php echo lang("contact_us_heading");?></h3>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group comman-group">
                                ...
                                <p id="contact_insta"><a href="javascript:void(0)"><?php if(isset($player_info->instagram) && $player_info->instagram!='0' && $player_info->instagram!='') {echo $player_info->instagram;}else{ echo "<strong>N/A</strong>"; } ?></a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group comman-group">
                                ...
                                <p id="contact_twitter"><a href="javascript:void(0)"><?php if(isset($player_info->twitter) && $player_info->twitter!='0' && $player_info->twitter!='') {echo $player_info->twitter;}else{ echo "<strong>N/A</strong>"; } ?></a></p>
                            </div>
                        </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                ...
                <div class="show_hide_club">
                    <div class="col-sm-4">
                        <div class="form-group comman-group">
                            <label for="exampleInputEmail1"><?php echo lang('club_name_label'); ?><span style="color: red;">*</span></label>
                            <input type="text" class="form-control" maxlength="30"  placeholder="<?php echo lang('club_name_label'); ?>" id="clubname" name="club_name">
                        </div>
                    </div>    
                </div>
