    ...
    if(data.type=='success'){
        ...
        if($("#"+id).length == 0){
            $("#add-more-image").parent(".add_more").parent("li").animate({
                ...
                $("#add-more-image").parent(".add_more").parent("li").remove();
                if(imageCount < 3){
                    $('#image-list').append('<li><div class="listInr"><div class="add_more custom-add-more"> <a data-toggle="modal" role="button" href="javascript:void(0)" id="add-more-image"><span><i aria-hidden="true" class="fa fa-pencil-square-o"></i></span>'+lang_js.add_more_button+'</a> </div></li></div>');
                }else{
                    $("#add-more-image").parent(".add_more").parent("li").remove();
                }
