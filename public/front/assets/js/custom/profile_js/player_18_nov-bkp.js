                ...
                $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if(videoCount < 3){
                                ...
                                $('#video-list').append('<li><div class="listInr"><div class="add_more custom-add-more"> <a id="add-more-video" href="javascript:void(0)" role="button" data-toggle="modal"><span><i class="fa fa-plus" aria-hidden="true"></i></span> '+lang_js.add_more_button+'</a> </div></div></li>');
                            }else{
          ...
          if(result) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(imageCount < 3){
                            $("#add-more-image").parent(".add_more").parent("li").remove();
                            $('#image-list').append('<li><div class="listInr"><div class="add_more custom-add-more"> <a data-toggle="modal" role="button" href="javascript:void(0)" id="add-more-image"><span><i aria-hidden="true" class="fa fa-pencil-square-o"></i></span>'+lang_js.add_more_button+'</a> </div></div></li>');
                        }
                        // if(imageCount < 3){
    ...
    $.ajax({
        ...
        success: function (data) {
            $("#add-more-image").parent(".add_more").parent("li").animate({
                ...
                $("#image-list").append('<li id="'+data.id+'"><div class="listInr"><div class="my_image"><a href=""><img src="' + playerIamge + '"/></a></div>\
                ...
                if(imageCount < 3){
                    $('#image-list').append('<li><div class="listInr"><d1iv class="add_more custom-add-more"> <a data-toggle="modal" role="button" href="javascript:void(0)" id="add-more-image"><span><i aria-hidden="true" class="fa fa-pencil-square-o"></i></span>'+lang_js.add_more_button+'</a> </div></div></li>');
                }else{
                    $("#add-more-image").parent(".add_more").parent("li").remove();
                }
                addImages();
    ...
    if(data.type=='success'){
        ...
        if($("#"+id).length == 0){
            $("#add-more-image").parent(".add_more").parent("li").animate({
                ...
                if(imageCount < 3){
                    $('#image-list').append('<li><div class="listInr"><d1iv class="add_more custom-add-more"> <a data-toggle="modal" role="button" href="javascript:void(0)" id="add-more-image"><span><i aria-hidden="true" class="fa fa-pencil-square-o"></i></span>'+lang_js.add_more_button+'</a> </div></li></div>');
                }else{
                    $("#add-more-image").parent(".add_more").parent("li").remove();
                }
...
//     var upload_upload_videoType = $("input[name='upload_videoType']:checked").val();
//     $(document).on("click","#updateVideo", function () {
//         //alert(upload_videoType);return false;
//         if(upload_upload_videoType=='1'){
//             var url = $('#update_video_url').val();
//             //alert(url); return false;
//             if(url=="" || url==null || url==undefined){
//                 $('.upd-comm-message').html('<div class="alert alert-danger hideauto"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><strong><span class="ui-icon ui-icon-alert" style="float:left"></span> Error! </strong>'+lang_js.common_required_this_field_is_required+'</div>');
//             }else{
//                   if(url.indexOf("https://vine.co/") == -1 && url.indexOf("https://www.youtube.com/") == -1 && url.indexOf("https://vimeo.com/") == -1) {
//                     $('#video_type').val('invalid');
//                     $('#video-type').val('invalid');
...
function showVideos(responseText)  { 
    ...
    if(data.type=='error'){
        ...
        $("#add-more-video").parent(".add_more").parent("li").animate({
            ...
            $("#video-list").append('<li id="'+data.id+'"><div class="listInr"><a href="javascript:void(0)" class="open-video" video_title= "'+data.title+'" video_url="'+data.filename+'" role="button" data-toggle="modal"><div class="my_vedio"><img src="' + data.thumbnail_image + '"/></div></a>\
                <div class="profile_edit"><p>'+data.title+'</p>\
    ...
    $.ajax({
        ...
        success: function (data) {
            for (var i in data) {
                ...
                $("#image-list").append('<li id="'+data[i].id+'"><div class="listInr"><div class="my_image"><a href="javascript:void(0)"><img src="' + playerIamge + '"/></a></div>\
        ...
        success: function (data) {
            for (var i in data) {
                if(data[i].upload_video_type==2){
                    $("#video-list").append('<li id="'+data[i].id+'"><div class="listInr"><a href="javascript:void(0)" class="open-video" video_title= "'+data[i].title+'" video_url="' +BASE_URL +'public/uploads/player_video/'+ data[i].filename+'" role="button" data-toggle="modal"><div class="my_vedio"><img src="' +BASE_URL +'public/uploads/video_thumb/'+ data[i].thumbnail_image + '"/></div></a>\
                    <div class="profile_edit"><p>'+data[i].title+'</p>\
                    ...
                    $("#video-list").append('<li id="'+data[i].id+'"><div class="listInr"><a href="javascript:void(0)" class="open-video" video_title= "'+data[i].title+'" video_url="'+data[i].filename+'" role="button" data-toggle="modal"><div class="my_vedio"><img src="' + data[i].thumbnail_image + '"/></div></a>\
                    <div class="profile_edit"><p>'+data[i].title+'</p>\
                    <div class="edit_delet"> <a class="editVideoBtn" data-toggle="modal" role="button" href="javascript:void(0)" video_id="'+data[i].id+'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> <a href="javascript:void(0)" class="deleteVideoBtn" video_id="'+data[i].id+'"><i class="fa fa-trash-o" aria-hidden="true"></i></a> </div>\
                    <div class="clearfix"></div></div></div></li>');
                }
