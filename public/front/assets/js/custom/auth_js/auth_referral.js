...
var login = (function() {
    var action = {
        ...
        regSteps: function() {
            ...
            // dealer asign dealer validation here
            $("#set-dealer").submit(function() {
                alert("submit test");
                return false;
                _that.setDealerValidation();
            });
            ...
            $('#reg-step-second-form').validate({
                ...
                rules: {
                    ...
                    email: {
                        ...
                        remote: {
                            ...
                            type: "post",
                            data: [{'name': "email", 'value': function() {
                ...
                messages: {
                    ...
                    email: {
                        ...
                        email: lang_js.customer_registration_email_valid,
                        maxlength: lang_js.customer_registration_email_max,
                        remote: lang_js.customer_registration_email_exist
                    },
                    gender: {
        ...
        // this is dealer validation here
        setDealerValidation: function() {
            var worning_msg = lang_js.select_dealer_select_dealer_msg;
            var owner_id = $('input[name=owner_id]:checked', '#set-dealer-form').val();
            if (owner_id == undefined || owner_id == "") {
                bootbox.alert(worning_msg, function() {
                });
                return false;
            } else {
                $("#set-dealer-form").submit();
            }
        },
