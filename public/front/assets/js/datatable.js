...
var Datatable = function (post_data) {
    ...
    return {
        ...
        init: function (options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "oLanguage": {// language settings
                        "sProcessing": '<img src="' + BASE_URL + 'public/admin/assets/img/loading-spinner-grey.gif"/><span>&nbsp;&nbsp;Loading...</span>',
                    ...
                    "fnServerParams": function (aoData) {
                        ...
                        aoData.push({"name": post_data.name, "value": post_data.val});
            ...
            table.on('keyup change blur', '.form-filter', function (e) {
                e.preventDefault();
